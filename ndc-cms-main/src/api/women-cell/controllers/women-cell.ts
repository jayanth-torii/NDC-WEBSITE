/**
 * women-cell controller
 */

import { factories } from '@strapi/strapi'

export default factories.createCoreController('api::women-cell.women-cell', ({ strapi }) => ({
  async find(ctx) {
    try {
      const entity = await strapi.entityService.findOne('api::women-cell.women-cell', 1, {
        populate: {
      ...
      console.error('Error fetching Women Cell data:', error);
      return ctx.badRequest('Error fetching Women Cell data', { moreDetails: error.message });
    }
  },
}));
