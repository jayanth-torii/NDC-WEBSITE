...
const NAV_GROUPS: { title?: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Admissions", to: `/page/admissions/${encodeURIComponent(API_ROUTES.ADMISSIONS.GET)}`, icon: HowToRegIcon },
      { label: "Alumni", to: `/page/alumni/${encodeURIComponent(API_ROUTES.ALUMNI.GET)}`, icon: GroupsIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Library", to: `/page/library/${encodeURIComponent(API_ROUTES.LIBRARY.GET)}`, icon: LocalLibraryIcon },
      { label: "Question Bank", to: `/page/question-bank/${encodeURIComponent(API_ROUTES.QUESTION_BANK.GET)}`, icon: QuizIcon },
