...
// Pagination state must stay client-side; everything else about this page
// (banner content, blog list) is now fetched server-side by app/blog/page.tsx
// and handed down as props.
export default function BlogListClient({ blogsData, bannerSection }: { blogsData: any[]; bannerSection: any }) {
