...
const Progression = () => {
  const { title, sections } = StudentCenterContent.progression;
        ...
        {sections.length > 0 ? (
          sections.map((section) => (
            ...
            >
              ...
              <button
                className="flex items-center border px-6 py-2 text-[#0e2455] hover:bg-[#0E2455] hover:text-[white] transition"
